...
namespace e4_9 { // extending namespace
...
StudentStack::~StudentStack() { delete [] stack_; }
...
bool StudentStack::empty() const { return top_ == -1; }

bool StudentStack::full() const { return top_ == size_ -1; }

void StudentStack::clearError() { errorState_ = STACK_OK; }

StudentStack::ErrorState StudentStack::getError() const { return errorState_; }
} // namespace e4_9
