...
//
// Implementation of class List for Example 7-1
...
T& List::ListIterator::operator*() { return current_->value_; }

const T& List::ListIterator::operator*() const { return current_->value_; }

List::ListIterator List::begin() const { return List::ListIterator(head_); }

List::ListIterator List::end() const { return ListIterator(); }
