...
public class QuadraticProbing
{
	...
	/** Performs the quadratic probing resolution to collisions.
	 *
	 * Quadratic probing operates by taking the original hash value and adding 
	 * successive values of a quadratic polynomial to the starting value.
	 *
	...
	{
		numCollisions = 0;
		int offset = 1;	// (aka step size) starts as 1 because 1^2 = 1
		...
		while(hashTable[currentPos]!=null && (hashTable[currentPos].element!=x))
		{
			...
			// f(i) = f(i-1) + 2i-1, is faster than f(i) = i^2
