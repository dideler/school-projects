...
<report name="Report3-all_user_transactions" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="REPORT3-ALL_USER_TRANSACTIONS" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="USER_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT	t.accid, RM.PURCHASED AS TID, RM.TITLE, 'PV Purchase' transactiontype
FROM RMCOPIES RM, TRANSACTION T
WHERE (RM.PURCHASED = T.TID) AND (T.ACCID  = :user_id)
UNION
SELECT t.accid, NM.TID, NM.TITLE, 'NM Purchase' transactiontype
FROM NMPURCHASE NM, TRANSACTION T
WHERE (NM.TID = T.TID) AND (T.ACCID = :user_id)
UNION
SELECT t.accid, R.RENTED, RM.TITLE, 'Rental' transactiontype
FROM RENTAL R, RMCOPIES RM, TRANSACTION T
WHERE (R.RMCID = RM.RMCID) AND (R.RENTED = T.TID) AND (T.ACCID = :user_id);]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_1">
        <displayInfo x="1.12097" y="1.94995" width="1.75818" height="0.97949"
        />
        <dataItem name="accid" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="15" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Account ID">
          <dataDescriptor expression="t.accid" descriptiveExpression="ACCID"
           order="1" oracleDatatype="aFixedChar" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TITLE" datatype="vchar2" columnOrder="13" width="50"
         defaultWidth="300000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Movie Title">
          <dataDescriptor expression="RM.TITLE" descriptiveExpression="TITLE"
           order="3" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="transactiontype" datatype="vchar2" columnOrder="14"
         width="11" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Transaction Type">
          <dataDescriptor expression="&apos;PV Purchase&apos;"
           descriptiveExpression="TRANSACTIONTYPE" order="4" width="11"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TID" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="120000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Tid">
          <dataDescriptor expression="RM.PURCHASED"
           descriptiveExpression="TID" order="2" oracleDatatype="number"
  ...
  <section name="main">
    <body>
      <frame name="M_G_1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.12500" height="0.37500"
        />
        ...
        <repeatingFrame name="R_G_1" source="G_1" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="6.12500"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_accid" source="accid" minWidowLines="1" spacing="0"
           alignment="start">
          ...
          <field name="F_TITLE" source="TITLE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.87500" y="0.18750" width="3.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_transactiontype" source="transactiontype"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.87500" y="0.18750" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_1_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="6.12500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="allPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableHeading"/>
          <text name="B_accid" minWidowLines="1">
          ...
          <text name="B_TITLE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.87500" y="0.00000" width="3.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_transactiontype" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.87500" y="0.00000" width="1.25000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.29126" y="0.75000" width="1.41736" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10" bold="yes"/>
          <string>
          <![CDATA[User Transactions]]>
          </string>
        </textSegment>
      </text>
    </margin>
