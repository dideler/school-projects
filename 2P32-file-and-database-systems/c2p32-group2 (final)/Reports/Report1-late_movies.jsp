...
<report name="Report1-late_movies" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="REPORT1-LATE_MOVIES" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT T.ACCID AS "Account ID", RM.TITLE AS "Movie Title", TRUNC(CURRENT_DATE - R.DUE) AS "Days Late"
FROM RMCOPIES RM, TRANSACTION T, RENTAL R
WHERE (R.DOR IS NULL) AND (R.RENTED = T.TID)
AND (R.RMCID = RM.RMCID) AND (RM.ISFORSALE = 0) AND (R.DUE < CURRENT_DATE)
ORDER BY R.DUE ASC;
]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_1">
        <displayInfo x="1.45007" y="1.94995" width="1.09998" height="1.62695"
        />
        <dataItem name="Account_ID_" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="11" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Account ID">
          <dataDescriptor expression="T.ACCID"
           descriptiveExpression="Account ID" order="1"
           oracleDatatype="aFixedChar" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="Movie_Title_" datatype="vchar2" columnOrder="12"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Movie Title">
          <dataDescriptor expression="RM.TITLE"
           descriptiveExpression="Movie Title" order="2" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="Days_Late_" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Days Late">
          <dataDescriptor expression="TRUNC ( CURRENT_DATE - R.DUE )"
           descriptiveExpression="Days Late" order="3" oracleDatatype="number"
  ...
  <section name="main">
    <body>
      <frame name="M_G_1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="3.87500" height="0.37500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"/>
        <repeatingFrame name="R_G_1" source="G_1" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="3.87500"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_Account_ID_" source="Account_ID_" minWidowLines="1"
          ...
          <field name="F_Movie_Title_" source="Movie_Title_" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.87500" y="0.18750" width="2.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_Days_Late_" source="Days_Late_" minWidowLines="1"
           spacing="0" alignment="center">
            <font face="helvetica" size="10"/>
        ...
        <frame name="M_G_1_HDR">
          ...
          <text name="B_Account_ID_" minWidowLines="1">
          ...
          <text name="B_Movie_Title_" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.87500" y="0.00000" width="2.25000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes" textColor="white"/>
          ...
          <text name="B_Days_Late_" minWidowLines="1">
            <textSettings justify="center" spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.54150" y="0.75000" width="0.95850" height="0.16675"
        />
        <textSegment>
...
<rw:dataArea id="MG1GRPFR1">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBAccountID1" asArray="no"/> class="OraColumnHeader"> Account ID </th>
   <th <rw:id id="HBMovieTitle1" asArray="no"/> class="OraColumnHeader"> Movie Title </th>
   <th <rw:id id="HBDaysLate1" asArray="no"/> class="OraColumnHeader"> Days Late </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RG111" src="G_1">
   <tr>
    <td <rw:headers id="HFAccountID1" src="HBAccountID1"/> class="OraCellText"><rw:field id="FAccountID1" src="Account_ID_" nullValue="&nbsp;"> F_Account_ID_ </rw:field></td>
    <td <rw:headers id="HFMovieTitle1" src="HBMovieTitle1"/> class="OraCellText"><rw:field id="FMovieTitle1" src="Movie_Title_" nullValue="&nbsp;"> F_Movie_Title_ </rw:field></td>
    <td <rw:headers id="HFDaysLate1" src="HBDaysLate1"/> class="OraCellNumber"><rw:field id="FDaysLate1" src="Days_Late_" nullValue="&nbsp;"> F_Days_Late_ </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
