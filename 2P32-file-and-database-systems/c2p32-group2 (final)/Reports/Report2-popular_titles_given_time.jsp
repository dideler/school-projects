...
<report name="Report2-popular_titles_given_time" DTDVersion="9.0.2.0.10">
...
from( --sum the counts for movies in different transactions
	select title as "Top 5 titles", sum("Total transactions") as "Total transactions"
	from ( --union of rented, pvpurchase and nmpurchase totals
		select rm.title, r.rented, count(*) as "Total transactions"
		from rental r, rmcopies rm, transaction t
		where (r.rmcid = rm.rmcid) and (t.tid = r.rented) and (t.dot between to_date(:start_date) and to_date(:end_date))
		group by rm.title, r.rented
		union all
		select nm.title, nm.tid, count(*) --per customer per transaction
		from nmpurchase nm, transaction t
		where (t.tid = nm.tid) and (t.dot between to_date(:start_date) and to_date(:end_date))
		group by nm.title, nm.tid
		union all
		select rm.title, rm.purchased, count(*)
		from rmcopies rm, transaction t
		where (rm.purchased is not null) and (t.tid = rm.purchased) and (t.dot between to_date(:start_date) and to_date(:end_date))
		group by rm.title, rm.purchased
		order by title desc)
	group by title
...
where rownum <= 5;]]>
      ...
      <group name="G_1">
        ...
        />
        <dataItem name="Top_5_titles" datatype="vchar2" columnOrder="13"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Top 5 Titles">
          <dataDescriptor expression="Top 5 titles"
           descriptiveExpression="Top 5 titles" order="1" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="Total_transactions" oracleDatatype="number"
         columnOrder="14" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="33"
         defaultLabel="Tot. Transactions">
          <dataDescriptor expression="Total transactions"
           descriptiveExpression="Total transactions" order="2" width="22"
           scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
  ...
  <section name="main">
    <body>
      <frame name="M_G_1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.12500" height="0.37500"
        />
        ...
        <repeatingFrame name="R_G_1" source="G_1" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="4.12500"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_Top_5_titles" source="Top_5_titles" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.00000" y="0.18750" width="2.62500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_Total_transactions" source="Total_transactions"
           minWidowLines="1" spacing="0" alignment="center">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.62500" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_1_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="4.12500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="allPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableHeading"/>
          <text name="B_Top_5_titles" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="0.00000" width="2.62500"
             height="0.18750"/>
          ...
          <text name="B_Total_transactions" minWidowLines="1">
            <textSettings justify="center" spacing="0"/>
            <geometryInfo x="2.62500" y="0.00000" width="1.50000"
             height="0.18750"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="0.47827" y="0.75000" width="3.41833" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10" bold="yes"/>
          <string>
          <![CDATA[Top 5 most popular titles over given time]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwblue"
   sectionTitle="Top 5 most popular titles over given time"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
